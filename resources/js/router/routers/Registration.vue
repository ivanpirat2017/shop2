      ...
      <div class="registrationItem background-black">
        <div class="registrationItemContent">
          ...
          <div class="bgrd p-15-10">
            <img src="../../../static/img/user.png" alt="" /><input
              type="text"
              placeholder="Имя"
              class=""
              v-model="name"
          ...
          <div v-if="err.tell != null">
            <p class="color-red">{{ err.tell[0] }}</p>
          </div>
          <div class="bgrd p-15-10">
            <img src="../../../static/img/phone.png" alt="" /><input
              type="tel"
              v-model="phonemask"
              class=""
          ...
          <div class="border-gray-f p-15-10">
            <img src="../../../static/img/padlock.png" alt="" /><input
              type="password"
          ...
          <div class="registrationItemContentBtn p-15-0">
            <button class="background-indigo" >
              Зарегистрироваться
            </button>
