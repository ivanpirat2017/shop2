...
<div class="Menu cnt-tovar">
    ...
    <div class="MenuTovar">
        <div class="MenuTovarBox">
            <img src="../../../static/img/nino.jpg" alt="">
            <div>
            <h1>Ninebot Air T 15</h1>
            <div class="text">
            <p>В наличии</p>
            <h3>49 990 p</h3>
            </div>
...
.Menu{
    ...
    &Fon{
        ...
        height: 640px;
        background: #00000048;
        background: url(../../../static/Tovar/main-monowheels--960.jpg) center center/cover no-repeat;
        @media screen and (max-width: 700px){
            width: 100%;
        }
    }
